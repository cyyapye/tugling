...
[`behavioral/`](behavioral/README.md) contains eight synthetic, executable cases plus a dependency-free no-Tugling/released/candidate runner and deterministic grader. It can also dogfood Tugling against a clean external project checkout while keeping project prompts and results outside this repository.
